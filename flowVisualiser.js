...
class Particle {
    ...
    updateParticle(volume) {
        ...
        if (this.timer >= 1) {
            ...
            this.x += this.speedX * (volume * randomSpeed + 2)
            this.y += -this.speedY * (volume * randomSpeed + 2)
...
module.exports = { main, hueChange, hueShiftChange, volumeChange, curveChange, zoomChange,
    xAdjustmentChange,  yAdjustmentChange, scrollSpeedChange, toggleBassMode }